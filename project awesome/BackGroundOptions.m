...
//  project awesome
//
//  Created by Christopher Fontas on 5/30/13.
...
@implementation BackGroundOptions

@synthesize backgroundsArray;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = [self.backgroundsArray objectAtIndex:indexPath.row];
